...
#import "NSArray+JLMASConstraint.h"

@implementation NSArray (JLMASConstraint)
...
- (void)jlMas_distributeViewsWithFixedLineSpacing: (CGFloat)fixedLineSpacing
    ...
    [self jlMas_distributeViewsWithFixedItemWidth:0 fixedItemHeight:0 fixedLineSpacing:fixedLineSpacing fixedInteritemSpacing:fixedInteritemSpacing warpCount:warpCount topSpacing:topSpacing bottomSpacing:bottomSpacing leadSpacing:leadSpacing tailSpacing:tailSpacing];
}
