...
+ (NSTimeInterval)timeTntervalInSecondsToStart:(NSString *)startStr withEnd:(NSString *)endStr {
    
    NSString *nowStr = [[NSDate date] stringWithFormat:@"yyyy-MM-dd"];
    startStr = [NSString stringWithFormat:@"%@ %@",nowStr,startStr];
    endStr = [NSString stringWithFormat:@"%@ %@",nowStr,endStr];
    NSDate *startDate = [NSDate date:startStr format:@"yyyy-MM-dd HH:mm"];
    NSDate *endDate = [NSDate date:endStr format:@"yyyy-MM-dd HH:mm"];
...
+ (NSDate *)date:(NSString *)datestr format:(NSString *)format {
...
- (NSString *)dateWithCustomFormat:(NSString *)formatStr {
