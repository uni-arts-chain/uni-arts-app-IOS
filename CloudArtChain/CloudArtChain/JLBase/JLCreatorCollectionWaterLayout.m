//
//  JLCreatorCollectionWaterLayout.m
//  CloudArtChain
//
...
@interface JLCreatorCollectionWaterLayout ()
...
@implementation JLCreatorCollectionWaterLayout
+ (instancetype)layoutWithColoumn:(int)coloumn data:(NSMutableArray *)dataA verticleMin:(float)minv horizonMin:(float)minh leftMargin:(float)leftMargin rightMargin:(float)rightMargin {
    JLCreatorCollectionWaterLayout *layout = [[JLCreatorCollectionWaterLayout alloc] init];
