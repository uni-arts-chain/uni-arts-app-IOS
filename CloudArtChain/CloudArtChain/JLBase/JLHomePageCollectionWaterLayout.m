//
//  JLHomePageCollectionWaterLayout.m
//  CloudArtChain
//
...
@interface JLHomePageCollectionWaterLayout ()
...
- (void)prepareLayout {
    ...
    for(int i = 0; i < self.iconArray.count; i++) {
        ...
        //计算每个cell的高度
        float itemH = [self getcellHWithOriginSize:CGSizeMake(itemW, 78.0f + iconModel.imgHeight) itemW:itemW];
        //计算当前cell处于第几列
