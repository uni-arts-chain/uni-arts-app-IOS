...
- (void)SetUpNetWorkParamters:(NSDictionary *)paramters isPullDown:(BOOL)isPullDown
{
    ...
    if ([self.RequestDelegate respondsToSelector:@selector(JLPagetableView:isPullDown:SuccessData:)]) {
        [self.RequestDelegate JLPagetableView:self isPullDown:isPullDown SuccessData:@[]];
    }
