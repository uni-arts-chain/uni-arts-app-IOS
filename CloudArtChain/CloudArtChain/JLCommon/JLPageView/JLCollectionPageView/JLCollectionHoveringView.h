 ...
 */
@protocol JLCollectionHoveringViewDelegate <NSObject>
@required
/**返回展示列表的tableView*/
- (NSArray*)listView;
//**必须设置的头部View*/
...
@interface JLCollectionHoveringView : UIView
@property (nonatomic , assign) id <JLCollectionHoveringViewDelegate> delegate;
