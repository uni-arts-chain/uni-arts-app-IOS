...
@interface JLScanViewController ()<AVCaptureMetadataOutputObjectsDelegate, AVCaptureVideoDataOutputSampleBufferDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
{
...
- (void)initUI {
    ...
    [_backBtn setImage:[UIImage imageNamed:@"icon_scan_back"] forState:UIControlStateNormal];
...
- (UILabel *)getTipsLabel {
    ...
    tipsLabel.textColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0f];
