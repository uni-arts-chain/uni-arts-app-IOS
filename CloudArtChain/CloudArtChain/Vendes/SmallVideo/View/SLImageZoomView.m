...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView {
    if (scrollView.isZooming || scrollView.isZoomBouncing) {
        ...
        CGFloat offsetX = (rect.size.width > scrollView.contentSize.width) ? ((rect.size.width - scrollView.contentSize.width) * 0.5f) : 0.0f;
        CGFloat offsetY = (rect.size.height > scrollView.contentSize.height) ? ((rect.size.height - scrollView.contentSize.height) * 0.5f) : 0.0f;
