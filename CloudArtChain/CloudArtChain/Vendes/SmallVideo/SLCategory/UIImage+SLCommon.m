...
- (UIImage *)sl_imageRotatedByRadians:(CGFloat)radians {
    ...
    CGRect clipTransRect = CGRectApplyAffineTransform(CGRectMake(0.0f, 0.0f, self.size.width, self.size.height), t);
    CGSize rotatedSize = clipTransRect.size;
    rotatedSize.width = ((int)(rotatedSize.width + 0.5f) * 1.0f);
    rotatedSize.height = ((int)(rotatedSize.height + 0.5f) * 1.0f);
