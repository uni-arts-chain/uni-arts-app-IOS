...
@interface WMPageController : JLBaseViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
/** 当选中或者滑动到视图控制器使用 */
- (void)didSelectViewControllerAtIndex:(int)index;
