...
#define kLoadImage(name) [UIImage imageNamed:name]
...
{
    [self showOnlyTextToView:nil title:message];
}

+ (void)showAutoMessage:(NSString *)message ToView:(UIView *)view
{
    [self showOnlyTextToView:view title:message];
}
...
+ (void)showSuccess:(NSString *)success toView:(UIView *)view {
    ...
    hud.customView = [[UIImageView alloc] initWithImage:kLoadImage(@"MBHUD_Success")];
}
...
+ (void)showError:(NSString *)error toView:(UIView *)view {
    ...
    hud.mode = MBProgressHUDModeCustomView;
    hud.customView = [[UIImageView alloc] initWithImage:kLoadImage(@"MBHUD_Error")];
}

+ (void)showInfo:(NSString *)Info ToView:(UIView *)view
{
    MBProgressHUD *hud = settHUD(view, Info, YES);
    hud.mode = MBProgressHUDModeCustomView;
    hud.customView = [[UIImageView alloc] initWithImage:kLoadImage(@"MBHUD_Info")];
}

+ (void)showWarn:(NSString *)Warn ToView:(UIView *)view
{
    MBProgressHUD *hud = settHUD(view, Warn, YES);
    hud.mode = MBProgressHUDModeCustomView;
    hud.customView = [[UIImageView alloc] initWithImage:kLoadImage(@"MBHUD_Warn")];
}
...
+(void)showLoadToView:(UIView *)view{
    [self showLoadToView:view title:@"加载中..."];
}
...
+ (void)showCheckmarkToView:(UIView *)toView title:(NSString *)title
{
    [self showCustomView:[[UIImage imageNamed:@"Checkmark"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]
                           toView:toView
                            title:title];
}
