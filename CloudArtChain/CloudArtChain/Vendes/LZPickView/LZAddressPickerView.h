...
;
//取消
@property(nonatomic,copy)void (^LZPickerClickCancleHandle)(void);
;
 ...
 * cancelBlock 取消
 */
- (void)showAddressPickerCompltedBlock:(void (^)(NSString *choseAddress,NSString *province , NSString *provinceID , NSString * city , NSString * cityId , NSString *area ,NSString *areaId))compltedBlock cancelBlock:(void (^)(void))cancelBlock;
