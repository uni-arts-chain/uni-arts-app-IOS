...
- (void)setupViews {
    ...
    detailsLabel.backgroundColor = JL_color_clear;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _progressRemainingColor = JL_color_clear;
        self.backgroundColor = JL_color_clear;
        self.opaque = NO;
    }
    return self;
...
- (void)setHighlighted:(BOOL)highlighted {
    ...
    self.backgroundColor = highlighted ? [baseColor colorWithAlphaComponent:0.1f] : JL_color_clear;
}
