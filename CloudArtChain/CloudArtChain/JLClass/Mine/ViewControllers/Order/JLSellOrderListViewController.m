//
//  JLSellOrderListViewController.m
//  CloudArtChain
//
...
#import "JLSellOrderListViewController.h"
#import "JLOrderDetailViewController.h"

#import "JLNoOrderView.h"
#import "JLSellOrderListTableViewCell.h"

@interface JLSellOrderListViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JLSellOrderListViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    [self createView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    WS(weakSelf)
    JLSellOrderListTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JLSellOrderListTableViewCell" forIndexPath:indexPath];
    cell.deliveringBlock = ^{
...
- (UITableView *)tableView {
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[JLSellOrderListTableViewCell class] forCellReuseIdentifier:@"JLSellOrderListTableViewCell"];
