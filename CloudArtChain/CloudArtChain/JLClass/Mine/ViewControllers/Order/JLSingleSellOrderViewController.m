//
//  JLSingleSellOrderViewController.m
//  CloudArtChain
//
...
@interface JLSingleSellOrderViewController ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JLSingleSellOrderViewController
...
- (void)requestOrder {
    WS(weakSelf)
    Model_arts_sold_Req *request = [[Model_arts_sold_Req alloc] init];
    request.page = self.currentPage;
    request.per_page = kPageSize;
    Model_arts_sold_Rsp *response = [[Model_arts_sold_Rsp alloc] init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JLSingleSellOrderListCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JLSingleSellOrderListCell" forIndexPath:indexPath];
