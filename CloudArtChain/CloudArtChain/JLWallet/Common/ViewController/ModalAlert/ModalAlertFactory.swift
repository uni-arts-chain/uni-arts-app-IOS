...
struct ModalAlertFactory {
    static func createSuccessAlert(_ title: String) -> UIViewController {
        ...
        let style = ModalAlertPresentationStyle(backgroundColor: UIColor.black,
                                                backdropColor: .clear,
                                                cornerRadius: 8.0)
    ...
    -> UIViewController {
        ...
        contentView.titleLabel.textColor = UIColor.white
        contentView.titleLabel.font = UIFont.p2Paragraph
        contentView.titleLabel.text = title
        contentView.titleLabel.textAlignment = .center
        contentView.imageView.image = UIImage(named: "iconValidBig")
