...
//        }
        ...
        guard let providerJsUrl = Bundle.main.url(forResource: "trust-min-tmp", withExtension: "js") else { return config }
...
//        let userScript = WKUserScript(source: js, injectionTime: .atDocumentStart, forMainFrameOnly: false)
        let injectedScript = WKUserScript(source: source, injectionTime: .atDocumentStart, forMainFrameOnly: false)
        let providerSource = try! String(contentsOf: providerJsUrl)
        let providerScript = WKUserScript(source: providerSource, injectionTime: .atDocumentStart, forMainFrameOnly: false)
