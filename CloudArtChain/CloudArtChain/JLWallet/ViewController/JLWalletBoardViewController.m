...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [JLUIFactory labelInitText:@"钱包是登录萌易唯一方式" font:kFontPingFangSCSCSemibold(18.0f) textColor:JL_color_black_34394C textAlignment:NSTextAlignmentCenter];
    }
    return _titleLabel;
}
