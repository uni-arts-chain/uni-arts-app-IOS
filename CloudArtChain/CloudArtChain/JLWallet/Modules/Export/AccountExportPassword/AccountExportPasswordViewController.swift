...
final class AccountExportPasswordViewController: UIViewController {
    ...
    private func setupLocalization() {
        ...
        hintLabel.text = "Password is required to encrypt your account and store as Restore JSON. Please, create password to continue operation."

        typeView.actionControl.contentView.titleLabel.text = "Source type"

        typeView.actionControl.contentView.subtitleLabelView.text = "Restore JSON"

        passwordInputField.title = "Set password"

        passwordConfirmField.title = "Confirm password"

        actionButton.imageWithTitleView?.title = "Continue"
    }
    ...
    private func setupErrorView() {
        ...
        view.iconImage = UIImage(named: "iconError")
    ...
    private func toggleSecurity(_ textField: UITextField, eyeButton: RoundedButton) {
        ...
        if isSecure {
            eyeButton.imageWithTitleView?.iconImage = UIImage(named: "iconEye")
        } else {
            eyeButton.imageWithTitleView?.iconImage = UIImage(named: "iconNoEye")
        }
