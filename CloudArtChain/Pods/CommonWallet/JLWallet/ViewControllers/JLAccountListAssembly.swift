...
final class JLAccountListAssembly: AccountListAssemblyProtocol {
    static func assembleView(with resolver: ResolverProtocol, balanceBlock: (([WalletViewModelProtocol]) -> Void)?) -> AccountListViewProtocol? {
        let view = JLAccountListViewController()
        ...
        presenter.updateBlock = balanceBlock
