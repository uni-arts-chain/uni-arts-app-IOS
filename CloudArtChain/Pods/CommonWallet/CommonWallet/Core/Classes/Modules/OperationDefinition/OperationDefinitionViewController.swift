...
public class OperationDefinitionViewController: AccessoryViewController {
    private struct Constants {
        static let horizontalMargin: CGFloat = 20.0
        static let amountHeight: CGFloat = 42.0
    }

    public var presenter: OperationDefinitionPresenterProtocol!
...
extension OperationDefinitionViewController: SelectedAssetViewDelegate {
    public func selectedAssetViewDidChange(_ view: SelectedAssetViewProtocol) {
        if view.activated {
...
extension OperationDefinitionViewController: DescriptionInputViewModelObserver {
    public func descriptionInputDidChangeText() {
        updateConfirmationState()
    }
}
