  ...
  struct nib: Rswift.Validatable {
    ...
    struct _PinSetupViewController: Rswift.NibResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        ...
        if #available(iOS 11.0, tvOS 11.0, *) {
          if UIKit.UIColor(named: "colorCellSelection", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Color named 'colorCellSelection' is used in nib 'PinSetupViewController', but couldn't be loaded.") }
        }
      }
